...
export const QuestionRouter = (router: express.Router, prefix='') =>{
    ...
    router.post(prefix+'/displayone/:id',TokenValidatorMiddlehare.tokenValidate, question.displayOne);
    router.post(prefix+'/displayall',TokenValidatorMiddlehare.tokenValidate,question.displayAll);
